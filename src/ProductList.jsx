...
import { addItem, calculateTotalQty } from "./CartSlice.jsx";
...
function ProductList({ onHomeClick }) {
    ...
    useEffect(() => {
        if (addedToCart.length !== Object.keys(cartItems).length) {
            var addedItems = [];
            cartItems.map(({ name }) => {
                ...
                <div style={styleObjUl}>
                    ...
                    <div> <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}>
                        <h1 className='cart'>
                            ...
                            <span className="cart_quantity_count">{ cartTotalQty }</span>
                        </h1>
                    </a></div>
                </div>
            </div>
                                    ...
                                    {plants.map((plant, plantIndex) => (
                                        <div className="product-card" key={plantIndex}>
                                            ...
                                            <button
                                                ...
                                                disabled={addedToCart.includes(plant.name) ?? true}
                                            >
